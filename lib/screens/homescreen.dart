...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<TravelDestination> rekomendasi = listDestination.where((element) => element.category == 'rekomendasi').toList();
      ...
      SizedBox(height: 20,),
        Expanded(child: SingleChildScrollView(
            ...
            padding: EdgeInsets.symmetric(
              horizontal: 15),
              child: Column(
                children: List.generate(rekomendasi.length,
